...
<head>
    ...
    <title>BPMS || Accepted Appointments</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Card header — green tint for "accepted" context ── */
        .card-bpms-header {
        ...
        .card-bpms-header .header-link:hover {
        ...
        .filter-bar select:focus { border-color: #059669; }
        ...
        table.bpms-table tbody tr:hover { background: #f0fdf4; }
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <div class="page-header-left">
                    <h2><i class="bi bi-calendar-check me-2"></i>Accepted Appointments</h2>
                    <p>All confirmed & accepted appointment bookings</p>
                </div>
            ...
            <?php
            /* ── Count accepted appointments for stat strip ── */
            $count_result  = mysqli_query($con, "SELECT COUNT(*) as total FROM tblbook WHERE Status='Selected'");
            $count_row     = mysqli_fetch_assoc($count_result);
            $total_accepted = $count_row['total'];
            ?>
            ...
            <div class="stat-strip">
                <div class="stat-pill">
                    ...
                    <span class="count"><?php echo $total_accepted; ?></span>
                </div>
                <div class="stat-pill">
            ...
            <div class="card-bpms">
                ...
                <!-- Card Header — green for accepted context -->
                ...
                <div class="table-wrapper">
                    <div class="table-responsive">
                        <table class="bpms-table" id="appointmentTable">
                            ...
                            <tbody>
                            <?php
                            /* ── Original query: Status = 'Selected' — unchanged ── */
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <!-- Status is always 'Selected' on this page -->
                                        <span class="status-pill accepted">
                                            <span class="dot-glow"></span>
                                            <?php
                                            /* Show actual DB value — preserves original logic */
                                    ...
                                    <td>
                                        <div class="action-cell">
                                            ...
                                            <!-- Note: original code deleted from all-appointment.php — preserved as-is -->
                                            <a href="accepted-appointment.php?delid=<?php echo $row['bid']; ?>"
                                               class="btn-delete"
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="empty-state">
                                            ...
                                            <p>There are no confirmed appointments at the moment. Check back soon!</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
