...
<head>
    ...
    <title>BPMS || New Appointments</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Layout wrapper (matches established system) ── */
        .dashboard-wrapper {
            margin-left: 280px;
            padding-top: 70px;
            min-height: 100vh;
        ...
        .filter-bar select:focus { border-color: #e91e63; }
        ...
        table.bpms-table tbody tr:hover { background: #fff5f9; }
...
<body>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <div class="page-header-left">
                    <h2><i class="bi bi-calendar-plus me-2"></i>New Appointments</h2>
                    <p>Pending appointments awaiting confirmation</p>
                </div>
            ...
            <?php
            /* ── Count pending appointments for the stat strip ── */
            $count_result = mysqli_query($con, "SELECT COUNT(*) as total FROM tblbook WHERE Status IS NULL");
            ...
            <div class="stat-strip">
                ...
                <div class="stat-pill">
                    <i class="bi bi-clock-history" style="color:#e91e63;"></i>
            ...
            <div class="card-bpms">
                ...
                <div class="card-bpms-header">
                    ...
                    <a href="all-appointment.php" class="btn btn-sm btn-light" style="border-radius:8px; font-size:0.8rem; font-weight:600; color:#e91e63;">
                        <i class="bi bi-grid-3x2-gap me-1"></i>All Appointments
                    </a>
                </div>
                        ...
                        <table class="bpms-table" id="appointmentTable">
                            ...
                            while ($row = mysqli_fetch_array($ret)) :
                                ...
                                if (!empty($row['Status'])) {
                                    ...
                                    if ($s === 'confirmed')  { $status_class = 'confirmed';  $status_label = 'Confirmed'; }
                                    elseif ($s === 'completed') { $status_class = 'completed'; $status_label = 'Completed'; }
                                    else { $status_label = htmlspecialchars($row['Status']); }
                                }
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-cell">
                                            ...
                                            <a href="new-appointment.php?delid=<?php echo $row['bid']; ?>"
                                               class="btn-delete"
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="empty-state">
                                            ...
                                            <p>All caught up! There are no pending appointment requests at the moment.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
    ...
    <!-- Bootstrap 5 JS (if not already loaded by header.php) -->
    <!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script> -->

    <!-- Live Search & Sort JS -->
    <script>
        /* ── Live search across all visible table cells ── */
        ...
        /* ── Sort by date (col index 4) ── */
        document.getElementById('sortSelect').addEventListener('change', function () {
            const order = this.value;          // 'asc' | 'desc' | ''
            if (!order) return;
